...
> The Rest API provided by Microverse allows the use of Post amd Get Using JS inbuilt function {fetch()}
...
```sh
  cd my-folder
  https://github.com/XRichardroidX/Leaderboard.git
```
...
Feel free to check the [issues page](https://github.com/XRichardroidX/Leaderboard/issues).
